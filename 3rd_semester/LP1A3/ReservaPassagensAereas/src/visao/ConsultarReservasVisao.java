...
public class ConsultarReservasVisao extends FormPadraoConsulta{
    ...
    public void inicializarComponentes() {
        ...
        jlMensagem = new JLabel("A quantidade de assentos indisponíveis nesse voo é");
    ...
    public void readJTable() {
        ...
        try {
            ...
            boolean[][] lugaresDisponiveis = new boolean[totalFileiras][totalColunas];
            modelo.addColumn("Assentos Indisponíveis");
